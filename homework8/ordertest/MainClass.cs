...
namespace ordertest {
    ...
    class MainClass {
        public static void Main() {
            try {
                Customer customer1 = new Customer(1, "Customer1","13907214906");
                Customer customer2 = new Customer(2, "Customer2","15926643449");
                ...
                Order order1 = new Order("20181114001", customer1);
                Order order2 = new Order("20181114002", customer2);
                Order order3 = new Order("20181114003", customer2);
